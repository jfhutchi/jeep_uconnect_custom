...
| Tiny resident arbitration implementation | JavaScript model plus C99 no-heap candidate; C source is 17,451 bytes across four files | MODEL_PROVED / TARGET_UNPROVED | C compile/tests, target ABI, linked map, allocated package bytes |

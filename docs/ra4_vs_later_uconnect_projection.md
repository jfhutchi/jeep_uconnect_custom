...
| Component | RA4 | Later projection-capable system | Confidence |
| --- | --- | --- | --- |
| product/supplier | Harman BE2800 CMC VP4 NA/CA | At least one Uconnect 4 VP4RAC is Panasonic; no board identity continuity is established | PROVED |
| SoC / CPU | TI OMAP3730, 32-bit Cortex-A8 | UNKNOWN from selected public sources | RA4 PROVED / later UNKNOWN |
| GPU / video | SGX530 and IVA2.2-class acceleration; installed H.264 ABI UNKNOWN | Production phone projection proves an integrated decode/display path; silicon UNKNOWN | RA4 PROVED+INFERRED / later functional PROVED |
| RAM | Capacity and normal-operation headroom UNKNOWN | UNKNOWN | UNKNOWN |
| storage | Approximately 77 MB writable observed; total device geometry and safe projection footprint UNKNOWN | UNKNOWN | RA4 observation / later UNKNOWN |
| USB controller | OMAP Mentor/MUSB and EHCI host HCDs; device-side route UNKNOWN | Production wired Android Auto/CarPlay through media USB; controller identity UNKNOWN | RA4 PROVED / later functional PROVED |
| media hub | 68141322AA/68289895AA SD/USB/AUX active module | Different Mopar hub family including 68294075AC; internal reason for change UNKNOWN | STRONGLY SUPPORTED |
| audio codec / DSP | AudioCtrlSvc/MME and audioApp mapping; silicon and PCM client contract UNKNOWN | Projection audio, voice and Siri function in production; component identity UNKNOWN | Functional only |
| Bluetooth / Wi-Fi | Stock Bluetooth and wireless infrastructure present; exact projection dependency outside USB is not required for the transport conclusion | VP4RAC FCC equipment includes BT/Wi-Fi/LTE | PROVED at system level |
| display / touch | 640x480 QNX Screen + CMC mtouch | 8.4-inch touch HMI supports projection, knobs and voice; pixel resolution/interface UNKNOWN | Functional PROVED |
| operating system | QNX 6.5 ARM32 | UNKNOWN | RA4 PROVED / later UNKNOWN |
| middleware / HMI | Adobe AIR/SWF, Harman ModuleLink/SVCIPC, dormant projection client contract and incompatible gateway | Production Projection Manager behavior; internal architecture UNKNOWN | RA4 PROVED / later functional PROVED |
| Apple authentication | Compatible authentication IC not identified | MFi authorization necessarily implemented; IC location not public in selected sources | Hard dependency PROVED / placement UNKNOWN |
| projection receiver | Named backend absent in bounded census | Android Auto and CarPlay production receiver present | PROVED within stated scopes |

...
ANCHORS = (
    ...
    Anchor("App SKU logger call", 0x110FF4, "instruction", "bl #0x143694"),
    Anchor("logger formatter dispatch", 0x1436DC, "instruction", "bl #0x13643c"),
    Anchor("bounded message formatting", 0x13647C, "instruction", "bl #0x103c10"),
    Anchor("logger sink virtual slot", 0x1364BC, "instruction", "ldr r3, [r3, #8]"),
    Anchor("early logger buffer sink", 0x2F72A0, "word", "0x143404"),
    Anchor("stdout sink table", 0x2F6B60, "word", "0x136D58"),
    Anchor("file sink table", 0x2F6B30, "word", "0x136EC4"),
    Anchor("file sink open", 0x136EE8, "instruction", "bl #0x10376c"),
    Anchor("file sink append mode", 0x2F772C, "string", "a"),
    Anchor("file sink message write", 0x136F3C, "instruction", "bl #0x1035b0"),
    Anchor("file sink close tail", 0x136F5C, "instruction", "b #0x103970"),
    Anchor("severity upper bound", 0x1333E8, "instruction", "bgt #0x133448"),
    Anchor("GUI accepted branch", 0x11DBB4, "instruction", "bne #0x11dde8"),
    Anchor("GUI accepted list", 0x11DDEC, "instruction", "ldr sb, [r8, #4]"),
    Anchor("filesystem factory", 0x3043D0, "word", "0x1CF260"),
    Anchor("filesystem provider lookup", 0x305358, "word", "0x1C44B0"),
    Anchor("provider constructor call", 0x1C45E0, "instruction", "bl #0x1c0f40"),
    Anchor("provider constructor table literal", 0x1C10D8, "word", "0x3052D8"),
    Anchor("provider identity slot", 0x305318, "word", "0x1B5070"),
    Anchor("backing identity virtual slot", 0x1B50A8, "instruction", "ldr r3, [r3, #0x38]"),
    Anchor("backing name identity implementation", 0x3047D8, "word", "0x1C9D30"),
    Anchor("backing provider factory", 0x304970, "word", "0x1B61B4"),
    Anchor("backing provider table literal", 0x1B61DC, "word", "0x3047A0"),
    Anchor("identity source name load", 0x1C9DA0, "instruction", "ldr r6, [r1]"),
    Anchor("identity name halfword conversion", 0x1C9DC8, "instruction", "bl #0x1312f8"),
    Anchor("record container pointer saved", 0x2540B8, "instruction", "str r8, [fp, #-0xd8]"),
    Anchor("record container constructor arg", 0x254174, "instruction", "ldr r3, [fp, #-0xd8]"),
    Anchor("record container backpointer", 0x2450AC, "instruction", "str r7, [r4, #0x28]"),
    Anchor("name lookup container backpointer", 0x240C1C, "instruction", "ldr r1, [r1, #0x28]"),
    Anchor("enumeration provider provenance", 0x23DFC4, "instruction", "str r3, [r7, #8]"),
    Anchor("lyc segment offset", 0x258024, "instruction", "str r0, [fp, #-0x48]"),
    Anchor("lyc segment size", 0x258020, "instruction", "str r3, [fp, #-0x44]"),
)
